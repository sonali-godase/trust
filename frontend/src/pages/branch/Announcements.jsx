...
const Announcements = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    message: '',
    priority: 'Normal',
    audienceType: ['Specific Branches'],
    targetBranches: [],
    targetRoles: [],
    targetUsers: [],
  ...
  const resetForm = () => {
    setFormData({
      title: '', subject: '', message: '', priority: 'Normal', audienceType: ['Specific Branches'],
  ...
  const handleEdit = (ann) => {
    ...
    setFormData({
      ...
      audienceType: ann.audienceType || ['Specific Branches'],
              ...
              <div className="p-6 overflow-y-auto custom-scrollbar flex-1">
                <form id="announcementForm" onSubmit={handleSubmit} className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                  ...
                  <div className="space-y-6">
                    ...
                    {/* Audience Selection */}
                    <div className="space-y-4 p-4 bg-slate-50 rounded-xl border border-slate-100">
                      <h4 className="font-bold text-slate-900 flex items-center gap-2"><FiUsers className="text-saffron-500"/> Audience</h4>
                      <p className="text-sm text-slate-500 font-medium bg-white p-3 rounded-lg border border-slate-200">
                        Broadcasts will automatically be targeted to users affiliated with your branch.
                      </p>
                    </div>
